...
# Paths
# ==============
path_train = '/usr/bmicnas01/data-biwi-01/bmicdatasets/Processed/USZ_BrainArtery/%s/folds/%d/train/'%(dataset, fold_id)
path_validation = '/usr/bmicnas01/data-biwi-01/bmicdatasets/Processed/USZ_BrainArtery/%s/folds/%d/val/'%(dataset, fold_id)
path_test = '/usr/bmicnas01/data-biwi-01/bmicdatasets/Processed/USZ_BrainArtery/%s/folds/%d/test/'%(dataset, fold_id)
...
tf_train = pytorch_tf.Compose([
                ...
                transformations.CropForeground((112,112,112), num=1),
